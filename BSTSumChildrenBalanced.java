...
class BinaryTree 
{
    ...
    Node ArrayToBST(int arr[], int start, int end) {
        ...
        node.leftchild = ArrayToBST(arr,start,m-1);
        node.rightchild = ArrayToBST(arr,m+1,end);
    ...
    int median(int start, int end) {
    	int x = (int)Math.floor((start+end)/2);
 //   	System.out.println(x);
    	return x;
    }
}
class BSTSumChildrenBalanced{
